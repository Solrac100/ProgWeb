<?php
  ...
  mysql_select_db('kardex') or die('No encontro la bd:'.mysql_error());
	...
	$qry = "SELECT * FROM materia ORDER BY nombre";
	...
	if (mysql_num_rows($tablaBD)>0) {
		...
		<body>
			...
			<table id='idTabla' border='1' align='center' width='430'>
				...
				while ($registro = mysql_fetch_array($tablaBD)) {
					...
					<tr>
						...
						-->
						<!--
						<td><a href='updMaterias.php?id=$id'>".$id."</a></td>
						-->
						<td><a href='updMaterias.php?id=$id'>".$clave."</td>
						<td>".$nombre."</td>
					</tr>
					";
				}
			...
			<table border='0' align='center' bordercolor='#FF333'>
				...
				<tr align='center'>
					<td width='1000' align='center'><font color='#FF333'>No existen registros en la tabla de Materias!!</font></td>
				</tr>
			</table>
			";
